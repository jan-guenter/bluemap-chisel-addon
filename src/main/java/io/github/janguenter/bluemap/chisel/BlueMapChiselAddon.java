 ...
 */
package io.github.janguenter.bluemap.chisel;

import io.github.janguenter.bluemap.chisel.adapter.bluemap522.AdapterCompatibility;

import java.lang.reflect.InvocationTargetException;
import java.lang.reflect.Method;

/** BlueMap add-on entrypoint installed before resource-pack construction. */
public final class BlueMapChiselAddon implements Runnable {

    public BlueMapChiselAddon() {
    }
    ...
    public void run() {
        try {
            ...
            Class<?> adapter = Class.forName(
                    "io.github.janguenter.bluemap.chisel.adapter.bluemap522.BlueMap522Adapter",
                    true,
                    BlueMapChiselAddon.class.getClassLoader()
            );
    ...
    private static void inactive(String reason, Throwable cause) {
        ...
        System.err.println("BlueMap Chisel add-on is inactive: " + reason + detail + ".");
    }
}
