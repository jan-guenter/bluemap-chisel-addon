...
public final class ProfileDisablement {
    ...
    public static final String SYSTEM_PROPERTY = "bluemap.chisel.disabledProfiles";
    public static final String ENVIRONMENT_VARIABLE = "BLUEMAP_CHISEL_DISABLED_PROFILES";
