...
class ChiselRendererFailurePolicyTest {
    ...
    void fallbackAtomicallyDropsPartialGeometryAndRestoresMapColor() {
        ...
        ChiselRenderer.resetPartialGeometry(target, start, changed, initial);
    ...
    void capacityFailureIsReturnedUnwrappedForImmediateRethrow() {
        ...
        assertSame(failure, ChiselRenderer.capacityFailure(failure));
    }
}
